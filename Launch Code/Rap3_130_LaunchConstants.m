...
function C = Rap3_130_LaunchConstants
    ...
    C.S1.Me = 326418.103280269; % 130 Pay
    % [kg]Stage 1 empty mass.

    C.S1.Mp = 3477296.71251002; % 130 Pay
    ...
    C.S2.Me = 139519.350435542; % 130 Pay
    % [kg]Stage 2 empty mass.

    C.S2.Mp = 1605767.25299637; % 130 Pay
    % [kg]Stage 2 propellant mass.

    C.S2.Isp = 380;
    % [s]Stage 2 specific impulse.

    C.S2.T = 2880 * 3 + 3045 * 3;
    % [kN]Stage 2 thrust.
